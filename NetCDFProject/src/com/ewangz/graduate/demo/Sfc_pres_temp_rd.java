...
public static void main(String args[]) throws Exception {
	...
	String filename = "nc/sfc_pres_temp.nc";
	...
	try {
		...
		System.out.println("presIn:");
		for(int i=0; i<NLAT; i++) {
		    for(int j=0; j<NLON; j++) {
		    	System.out.printf("%3.1f",presIn[i][j]);
		    	System.out.print("  ");
		    }
		    System.out.println();
		}
		...
		for(int i=0; i<NLAT; i++) {
		    for(int j=0; j<NLON; j++) {
		    	System.out.printf("%-4.1f",tempIn[i][j]);
		    	System.out.print("  ");
		    }
		    System.out.println();
		}
		System.out.println("latsIn:");
		for(int i=0; i<NLAT; i++) {
		    System.out.printf("%-4.1f",latsIn[i]);
		    System.out.print("  ");
		}
		System.out.println("\nlonsIn:");
		for(int i=0; i<NLON; i++) {
		    System.out.printf("%-4.1f",lonsIn[i]);
		    System.out.print("  ");
		}
	}
